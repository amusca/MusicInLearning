...
<audio controls>
  <source src="Honours 3 beta waves.mp4" type="audio/mpeg">
</audio> 
...
```{r}
  p = ggplot(HpResults, aes(SC4, SC5)) + geom_point() + geom_violin()
  ggMarginal(p, type="histogram")
```
...
```{r}
  p = ggplot(HpResults, aes(SC6, SC7), size = "pop") + geom_point(color="black",
        fill="#69b3a2",
        shape=21,
        alpha=0.5,
        size=6,
