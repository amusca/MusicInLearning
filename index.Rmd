...
We will investigate whether the calming nature of beta waves indeed leads to enhanced recall, as suggested by the higher mean score in that group. To comprehensively understand the significance of our findings, two ANOVA analyses will be carried out. This statistical approach will help us discern if the observed differences in mean scores among the various music genres are statistically significant. The preliminary examination of the results suggests potential significance for all music genres compared to the control group, with beta waves performing better, and classical, pop and rock music performing worse than no music, however these trends require a deeper statistical exploration that is to follow in the “Results” and “Discussion” section.
...
The “Wrong Answers'' histograms indicate how many numbers that were not in a certain video were clicked by the survey participants. By comparing the graphs it can be observed that on average people selected the most wrong answers when listening to classical music, while the average number of wrong answers for other genres were all below 1 and quite close to each other. This could among others be due to one of the points listed later in the “Limitations” section, namely that two numbers have been accidentally repeated in the classical music video which could have confused participants. Thus we can not draw any conclusions from the distribution of wrong answers for the different genres.

In the “Control” sections the results of the exercise in which there was no  background music are displayed.  It can be observed that most people scored between 6 to 8 points and on average the participants picked 0 to 1 numbers that were not in the video.

In the Beta Waves exercise people tended to score better than in the other exercises. The most correct answers were between 4 and 6, but it can also be observed that there are more participants that scored between 6 and 10 points than in other sections. The wrong answer rate was also smaller than in other genres. This is a surprising result, as we initially expected the participants to score the best in the control exercise, as we believed any background noise could be a potential distraction. A more detailed analysis of these findings will follow in the “Discussion” section.

With Classical music playing in the background, most people scored on average 6 points out of 10, but it is also to be noted that most of the participants picked one or two wrong answers. Therefore, it could theoretically be stated that the overall worst performance across genres - taking both the normal scores and the wrong answers into account - was observed for the Classical music exercise. However, due to our limitations we do not wish to draw any such conclusions.

In the Pop music exercise, most participants scored between 4 to 6 out of 10. It can be also observed that most people had at least one wrong answer. Similarly to Pop music, when listening to rock music, the participants scored mostly between 4 to 6 points, but there were way less wrong answers than expected.


### Other Variables

The “Age” section displays the average normal scores by age category. According to the collected data, people younger than 18 years old scored better in our survey than other age categories. It also should be noted that people aged between 18 to 22 and more than 35 scored on average very close to 5 out of 10 points, while people between 23 and 27 years old had a slightly worse performance.

In the “Task” section we present the average scores the participants obtained categorized by whether their daily tasks include more numbers and statistics or reading and writing. Interestingly,  people that do both types of tasks performed better than the others, being closely followed by the ones that mainly engage in numerical or statistical tasks. The participants that selected writing and reading performed visibly worse, which was expected given that the exercises involved the memorization of numbers.

In the “Study” section we show the average scores of the participants according to their field of study. Surprisingly, people who study humanities score way better than those in formal, numerical, or applied sciences. The worst results were obtained by natural science students, being closely followed by social science students.

In the “Significance” section we present the average scores of the participants categorized by how significant music is in their lives. People that indicated “To a large extent” scored the best, while the ones that chose “To some extent” did on average the worst. We cannot draw a conclusion from this bar chart which could state that the significance of music in people’s lives could have helped them getting better scores as the options “To little extent”, “To a very large extent” and “To a large extent” were pretty close to each other.
